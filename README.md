...
## :scroll: General info
  ...
  A diet recommendation web application using content-based approach with Scikit-Learn, FastAPI and Streamlit. A full-stack web application that recommends personalized food & diet plans based on your "nutrition goals" and "ingredients".  
